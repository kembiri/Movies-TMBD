...
const key =
  "&api_key=046fdb0d753c6903e673934705cb553f&language=en-US&include_image_language=en-US,null";
...
const apikey = "?api_key=046fdb0d753c6903e673934705cb553f";
...
function search(e) {
  $(".movies").remove(),
    ...
    $(".shows-container-contain").hide();
  $.getJSON(
    "https://api.themoviedb.org/3/search/multi?api_key=046fdb0d753c6903e673934705cb553f&query=" +
      e,
    function (e) {
...
function movieInfo(l) {
  $.getJSON(movieCast + l + "/casts?" + key, function (e) {
    ...
    const s =
      ...
      l +
      "?api_key=046fdb0d753c6903e673934705cb553f&append_to_response=videos,external_ids";
...
function tvInfo(d) {
  ...
  const e =
    ...
    d +
    "?api_key=046fdb0d753c6903e673934705cb553f&append_to_response=images,seasons,keywords,external_ids";
...
function seriesInfo(a, o) {
  const e =
    ...
    "/season/" +
    o +
    "?api_key=046fdb0d753c6903e673934705cb553f&append_to_response=keywords,external_ids";
  $.getJSON(e, function (e) {
    $(".episodes").empty();
